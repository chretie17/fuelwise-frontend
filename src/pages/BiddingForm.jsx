...
const BiddingForm = () => {
  ...
  const handleSubmitBid = async () => {
    try {
      const supplierId = localStorage.getItem('supplierId'); // Assuming supplier ID is stored after login
      const response = await axios.post(`${API_BASE_URL}/bids/submit`, {
